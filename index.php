<?php get_header();?>
            ...
            <?php
            $section_id = 267 ;
            get_template_part('sections-templet/banner');
            ?>
                ...
                <div class="section bg-white pt-2 pb-2 text-center" data-aos="fade">
                    <p><img src="<?php echo get_template_directory_uri();?>/assets/images/bg_hero.png" alt="Image" class="img-fluid"></p>
                </div>
                                    ...
                                    <div class="tab-pane fade show active" id="pills-breakfast" role="tabpanel" aria-labelledby="pills-breakfast-tab">
                                        <div class="d-block d-md-flex menu-food-item">
                                            <div class="text order-1 mb-3">
                                                <img src="<?php echo get_template_directory_uri();?>/assets/images/img_1.jpg" alt="Image">
                                        ...
                                        <div class="d-block d-md-flex menu-food-item">
                                            <div class="text order-1 mb-3">
                                                <img src="<?php echo get_template_directory_uri();?>/assets/images/img_2.jpg" alt="Image">
                                        ...
                                        <div class="d-block d-md-flex menu-food-item">
                                            <div class="text order-1 mb-3">
                                                <img src="<?php echo get_template_directory_uri();?>/assets/images/img_3.jpg" alt="Image">
